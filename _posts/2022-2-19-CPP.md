...
- [类](#head12)
	...
	- [转换函数](#head14)
	- [友元函数](#head15)
	- [Private,friend,public,protected](#head16)
	- [虚函数](#head17)
	- [类继承](#head18)
		- [私有继承](#head19)
		- [保护成员](#head20)
...
## <span id="head12">类</span>

### <span id="head13">构造函数</span>
...
### <span id="head14">转换函数</span>

```C++
operator typename();
```

### <span id="head15">友元函数</span>
...
### <span id="head16">Private,friend,public,protected</span>

friend的作用见上

protected用于类继承时，派生类对声明为protected的基类的成员可以直接访问

### <span id="head17">虚函数</span>
